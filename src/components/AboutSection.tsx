  ...
  return (
    <section id="about" className="py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <SectionTitle eyebrow="About Us" title="A quiet luxury, thoughtfully hosted" subtitle="Essence Place Hotel & Lounge blends boutique comfort with an intimate lounge experience — designed for travellers, celebrants, and anyone chasing an unforgettable evening." />
