...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Essence Place & Lounge — Luxury Rooms, Lounge & Bar" },
      { name: "description", content: "Book luxury rooms and order premium drinks at Essence Place  & Lounge. Simple WhatsApp checkout — no account required." },
      { name: "author", content: "Essence Place" },
      { name: "theme-color", content: "#111111" },
      { property: "og:title", content: "Essence Place & Lounge" },
      ...
      { property: "og:site_name", content: "Essence Place & Lounge" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Essence Place & Lounge" },
